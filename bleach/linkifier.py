...
TLDS = """ac ad ae aero af ag ai al am an ao aq ar arpa art as asia at au aw ax az
       ba bb bd be bf bg bh bi bio biz bj bm bn bo br bs bt bv bw by bz ca cafe cat
       cc cd cf cg ch ci city ck cl cm cn co com coop cr cu cv cx cy cz de dev dj dk
       dm do dz ec edu ee eg er es et eu fan fi fj fk fm fo fr ga gb gd ge gf gg
       gh gi gl gm gn gov gp gq gr gs gt gu guru gw gy hk hm hn hr ht hu id ie il
       ...
       sm sn so sr ss st su sv sx sy sz tc td tech tel tf tg th tj tk tl tm tn to top
       tp tr travel tt tv tw tz ua ug uk us uy uz va vc ve vg vi vn vu wf ws
       xn xxx xyz ye yt yu za zm zw""".split()
